...
# Charger les données
df = spark.read.option("header", "true").csv("/opt/bitnami/spark/Architecture_Medaillon/bronze/Etablissement_information.csv")
...
df_cleaned.write.mode("overwrite").option("header", "true").csv("/opt/bitnami/spark/Architecture_Medaillon/silver/Etablissement_information_cleaned.csv")